...
class aw_notification extends aw_base
{
	...
	*/
    ...
    /**
     * getAllUsers4Notification
     * -----------------------------------------------------------------------------------------------------------------
     * @param integer $iNotificationType
     * @return array
     */
     ...
     * @return bool
     */
    public function addDBNotification($aUser,$iNotificationType){
		...
		$sAddDBNotification= "INSERT INTO awnotifications (awuserid,awchanginguser,awprojectid,awtaskid,awtype,awdatetime,awisread) VALUES ('".$aUser['awid']."','".$_SESSION['awid']."','".$awprojectid."','".$awtaskid."','".$iNotificationType."','".$actDateTime."','0')";
     ...
     * @param integer $iNotificationType
     */
    public function sendMailNotification($aUser,$iNotificationType){
		...
		$smarty->assign('awuserid',$aUser['awid']);
