...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link href="{$tpldir}src/themefiles/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="index.php" method="post">
			...
			<div class="row">
				<div class="col-xs-4">
					<button type="submit" class="btn btn-primary btn-block btn-flat">{awmultilang ident="LOGIN"}</button>
				</div><!-- /.col -->
			</div>
        </form>
    ...
    <!-- iCheck -->
    <script src="{$tpldir}src/themefiles/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
    <script>
      $(function () {
        $('input').iCheck({
