    ...
    public function __construct()
    {
        ...
        if (empty($_POST)) {
            if (empty($this->getParameter('fnc')) && $this->getParameter('cl') === 'prioritys') {
                $smarty->display('tpl/administration/prioritys/prioritys.tpl');
                ...
                $smarty->display('tpl/administration/prioritys/prioritys-edit.tpl');
            } elseif ($this->getParameter('fnc') === 'add' && $this->getParameter('cl') === 'prioritys') {
                $smarty->display('tpl/administration/prioritys/prioritys-add.tpl');
