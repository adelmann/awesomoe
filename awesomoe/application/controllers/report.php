    ...
    public function __construct()
    {
        ...
        if (empty($_POST)) {
            if (empty($this->getParameter('fnc')) && $this->getParameter('cl') == 'report') {
                ...
                $smarty->assign('oReportsCount',
                    $this->countAllReports4Project());
                if ($this->getParameter('awid')) {
            ...
            if ($this->getParameter('fnc') === 'save' && $this->getParameter('cl') === 'report') {
                $this->save();
                if (!empty($this->getParameter('awid')) && $this->getParameter('awid') != '-1') {
                    $sReportId = '&awid=' . $this->getParameter('awid');
                } else {
                    $sReportId = "";
                }
